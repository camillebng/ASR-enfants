...
where ffmpeg >nul 2>nul || "%LOCALAPPDATA%\Microsoft\WindowsApps\winget.exe" install --id Gyan.FFmpeg --silent --exact --accept-source-agreements --accept-package-agreements
